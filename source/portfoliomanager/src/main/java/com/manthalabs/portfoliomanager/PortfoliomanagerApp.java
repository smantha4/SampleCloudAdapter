...
public class PortfoliomanagerApp {
    ...
    private static final Logger log = LoggerFactory.getLogger(PortfoliomanagerApp.class);
    ...
    public static void main(String[] args) throws UnknownHostException {
        SpringApplication app = new SpringApplication(PortfoliomanagerApp.class);

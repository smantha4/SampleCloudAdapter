(function() {
    ...
    function jhiAlertErrorController ($scope, AlertService, $rootScope) {
        ...
        var cleanHttpErrorListener = $rootScope.$on('portfoliomanagerApp.httpError', function (event, httpResponse) {
            var i;
            ...
            case 400:
                var errorHeader = httpResponse.headers('X-portfoliomanagerApp-error');
                var entityKey = httpResponse.headers('X-portfoliomanagerApp-params');
                if (errorHeader) {
